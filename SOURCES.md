...
Orderly remains named where necessary to identify the real protocol, upstream source, headers, endpoint hosts, or documentation MCP. Sol Perps Dex is the user-facing project name. No endorsement, ownership transfer, or affiliation claim is made.
...
6. Product broker is `sol_perps_dex`; [solperpsbot.io](https://solperpsbot.io), [docs.solperpsbot.io](https://docs.solperpsbot.io), and [API key UI](https://solperpsbot.io/portfolio/api-key) are user-provided product configuration, not independently tested deployment guarantees. Broker is not an arbitrary order parameter.
...
[Project index](README.md) · [Onboarding](skills/sol-perps-onboarding/SKILL.md) · [Authentication](skills/sol-perps-api-authentication/SKILL.md) · [Account data](skills/sol-perps-account-data/SKILL.md) · [Trading orders](skills/sol-perps-trading-orders/SKILL.md) · [Positions/risk](skills/sol-perps-positions-risk/SKILL.md)
