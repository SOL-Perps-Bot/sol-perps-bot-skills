# Sol Perps Dex skills

Original, concise agent procedures for **Sol Perps Dex**, broker `sol_perps_dex`.

- Website: [solperpsbot.io](https://solperpsbot.io)
- Product documentation: [docs.solperpsbot.io](https://docs.solperpsbot.io)
- API key UI: [Portfolio → API key](https://solperpsbot.io/portfolio/api-key)
...
| Skill | Use it for |
| --- | --- |
| [sol-perps-onboarding](skills/sol-perps-onboarding/SKILL.md) | Safe setup, broker context, selecting the next guide |
| [sol-perps-api-authentication](skills/sol-perps-api-authentication/SKILL.md) | API seed handling, exact request signing, auth diagnostics |
| [sol-perps-account-data](skills/sol-perps-account-data/SKILL.md) | Read account configuration, holdings, positions, orders |
| [sol-perps-trading-orders](skills/sol-perps-trading-orders/SKILL.md) | Scoped order review, pre-send caps, submission reconciliation |
| [sol-perps-positions-risk](skills/sol-perps-positions-risk/SKILL.md) | Risk interpretation, symbol-specific leverage, authorized reductions |
